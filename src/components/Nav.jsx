...
// Animations
import { inView2, inView } from "../../animations";

const Nav = () => {
  const location = useLocation().pathname;
  const [isOpen, setIsOpen] = useState(false);
  return (
    <StyledNav variants={inView} initial="hidden" animate="show">
      <Container>
        <RiotLogo width="85" height="27" viewBox="0 0 587.93 165">
      ...
      <div className="burger">
        {!isOpen && <GiHamburgerMenu onClick={() => setIsOpen(!isOpen)} />}
        {isOpen && (
          <IoMdClose
            style={{ fill: "rgb(254, 70, 85)" }}
          ...
          <div className="container">
            ...
            >
              ...
              <Link
                ...
                style={{
                  textDecoration: "none",
                  color: location === "/agents" ? "#FD4655" : "#f9f9f9",
                }}
                to="/agents"
              >
                <li>Agents</li>
              ...
              <Link
                style={{
                  textDecoration: "none",
                  color: location === "/maps" ? "#FD4655" : "#f9f9f9",
                }}
                onClick={() => setIsOpen(!isOpen)}
                to="/maps"
              >
      ...
      <Options>
        <Wrap>
          <Link style={{ textDecoration: "none", color: "#f9f9f9" }} to="/">
            <li>Home</li>
            <div
              className="line"
              style={{ width: location === "/" ? "70%" : "0%" }}
            ></div>
          </Link>
        </Wrap>
        <Wrap>
          ...
          >
            ...
            <div
              className="line"
              style={{ width: location === "/agents" ? "70%" : "0%" }}
            ></div>
          </Link>
        </Wrap>
        <Wrap>
          <Link style={{ textDecoration: "none", color: "#f9f9f9" }} to="/maps">
            <li>Maps</li>
            <div
              className="line"
              style={{ width: location === "/maps" ? "70%" : "0%" }}
            ></div>
          </Link>
        </Wrap>
      </Options>
...
const ValorantLogo = styled(RiotLogo)`
...
const MobileOptions = styled(motion.div)`
  width: 100%;
  height: 100%;
  background-color: #111;
  color: white;
